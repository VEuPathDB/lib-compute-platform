...
[source, kotlin]
----
include::src/main/kotlin/org/veupathdb/lib/compute/platform/config/AsyncPlatformConfig.kt[lines="19..25"]
----
...
[source, kotlin]
----
include::src/main/kotlin/org/veupathdb/lib/compute/platform/config/AsyncDBConfig.kt[lines="30..37"]
----
